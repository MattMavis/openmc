/* This is for domain decomposition (temporary solution) */

#ifndef OPENMC_LOCATIONS_H
#define OPENMC_LOCATIONS_H
...
/******** Sensitivity/perturbation calculations ***/
  ...
  DATA_SENS_N_ENE,
  DATA_SENS_N_MU,
  DATA_PTR_SENS_ZAI_ARR,
  DATA_PTR_SENS_MAT_ARR,
  DATA_SENS_LAST_GEN,
  DATA_SENS_PERT_FLAGS,
  DATA_SENS_RESP_FLAGS,
  DATA_SENS_SCORE_FLAGS,
  DATA_PTR_SENS_PERT_INDICES,
  DATA_PTR_SENS_MAT_INDICES,
  DATA_PTR_SENS_ZAI_INDICES,
  DATA_PTR_SENS_MT_INDICES,
  DATA_SENS_MAX_SCATT_MOM,
  DATA_SENS_MAX_MT,
  DATA_SENS_MAX_XS_INDEX,
  DATA_PTR_SENS_RESP0,
  DATA_PTR_SENS_PERT0,
  DATA_PTR_SENS_VOID_MAT,
  DATA_SENS_SCORE_TYPE,
  DATA_SENS_MAX_LABEL,
  DATA_SENS_PTR_REA_LIST,
  DATA_SENS_PTR_MT_LIST,
  DATA_SENS_MU_BIN_TYPE,
...
enum block_MATERIAL {
  ...
  MATERIAL_SORT_IDX,
  MATERIAL_POSMAT_INTEGER,
  MATERIAL_BLOCK_SIZE
};

/*****************************************************************************/

/***** Posmat variables including mesh and number of points ******************/

enum block_POSMAT {
  POSMAT_PTR_MESH_NAME = LIST_DATA_SIZE,
  POSMAT_NPOINTS,
  POSMAT_BLOCK_SIZE
};
...
/***** Auxiliary data from ENDF file *****************************************/

enum block_AUX_LIST {
  AUX_ZAI = LIST_DATA_SIZE,
  AUX_MAT,
  AUX_NPLY,
  AUX_EFR,
  AUX_ENP,
...
enum block_AUX_REA_LIST {
  AUX_REA_MT = LIST_DATA_SIZE,
  AUX_REA_QM,
  AUX_REA_QI,
  AUX_REA_LIST_BLOCK_SIZE
};
...
enum block_IFC_OF_BATCH {
  IFC_OF_BATCH_PTR_NAME = LIST_DATA_SIZE,
  IFC_OF_BATCH_PTR_TYPE,
...
enum block_DET_FET {
  DET_FET_MESH_TYPE = LIST_DATA_SIZE,
  DET_FET_NDEG0,
  DET_FET_NDEG1,
  DET_FET_NDEG2,
  DET_FET_MIN0,
...
enum block_WWD_ITER {
  ...
  WWD_ITER_SPLIT_YMIN,
  WWD_ITER_SPLIT_ZMIN,
  WWD_ITER_SPLIT_MFP_NL,
  WWD_ITER_SPLIT_MFP_NBTCH,
  WWD_ITER_SPLIT_MFP_DENS,
...
/* NOTE: Different pointers for photons and neutrons */
